...
export default function AdvertisementDetails() {
    ...
    return (
        <> {/*== Start Product Details Area Wrapper ==*/}
            ...
            < section className="app-container section-space" style={{ marginTop: "-50px" ,marginBottom:'-100px'}} >
                        ...
                        <div className="row product-details">
                            ...
                            <div className="col-lg-7">
                                <div className="product-details-content">
                                    ...
                                    <Link className="btn bg-info"  style={{marginRight:'20px'}}  to={`/Advertisements/Update/${advertisement.slug}`} state={{ advertisementId: advertisement._id }} >Update <i className="fa-solid fa-gear"></i></Link>
                                    <Link className="btn col-md-5"to={`/Advertisements/${advertisement.slug}/AddService`} state={{ advertisementId: advertisement._id }}>Add Service</Link>
                                            ...
                                            </div>
                                            {
                                                advertisement.Services.map((service) => <div className="products-row mt-1" key={service._id}>
                                                    ...
                                                    <div className="product-cell image">
                                                        ...
                                                        <Link to={`/Advertisements/${advertisement.slug}/${service.slug}`} state={{ serviceId: service._id, advertisementId: advertisement._id }} className='title text-capitalize'>{service?.name}</Link>
                                                    </div>
