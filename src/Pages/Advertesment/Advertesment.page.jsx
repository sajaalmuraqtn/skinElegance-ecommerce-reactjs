    ...
    return (
        <>
            <div className="app-content" style={{ height: advertisements.length < 10 ? "100vh" : '' }}>
                {
                    advertisements.length == 0 ? <Loading margin={50} height={100} fontSize={70} />
                            ...
                            <div className="products-area-wrapper tableView">
                                ...
                                {advertisements.map((advertisement) => <div className="products-row mt-1">
                                    <div className="product-cell image">
                                            ...
                                            <Link to={`/Advertisements/${advertisement.slug}`} state={{ advertisementId: advertisement._id }} className='title text-capitalize'>{advertisement?.name}</Link>
                                        </div>
